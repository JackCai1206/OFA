...
data=${data_dir}/vg_train_above.tsv,${data_dir}/vg_val_above.tsv
...
log_file=${log_dir}/${tag}_${max_epoch}"_"${lr}"_"${patch_image_size}_mix_above".log"
save_path=${save_dir}/${tag}_${max_epoch}"_"${lr}"_"${patch_image_size}_mix_above
